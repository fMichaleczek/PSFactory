...
Describe 'Set-SnakeTaskVariable' {
    ...
    Context 'When calling the function with parameter AsNewBuild' {
        ...
        It 'Should return the expected output' {
            <#
                Since PSnake adds its own alias in build.ps1 that does not point
                to the built module's Set-SnakeTaskVariable we must point
                out that the alias to test is the one in the module.
            #>
            $result = . PSnake\Set-SnakeTaskVariable -AsNewBuild
        ...
        Context 'When BuiltSubModuleDirectory is set in the build configuration file' {
            ...
            It 'Should return the expected output' {
                $result = . PSnake\Set-SnakeTaskVariable -AsNewBuild -Verbose
    ...
    Context 'When calling the function without a parameter' {
        ...
        It 'Should return the expected output' {
            <#
                ...
                out that the alias to test is the one in the module.
            #>
            $result = . PSnake\Set-SnakeTaskVariable
        ...
        Context 'When BuiltSubModuleDirectory is set in the build configuration file' {
            ...
            It 'Should return the expected output' {
                <#
                    ...
                    out that the alias to test is the one in the module.
                #>
                $result = . PSnake\Set-SnakeTaskVariable -Verbose
