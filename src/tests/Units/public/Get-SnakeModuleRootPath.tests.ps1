...
Describe 'Get-SnakeModuleRootPath' {
    Context 'When module manifest does not contain the property RootModule' {
        ...
        It 'Should return $null' {
            $result = PSnake\Get-SnakeModuleRootPath -ModuleManifestPath $TestDrive
    ...
    Context 'When module manifest property RootModule' {
        ...
        It 'Should return $null' {
            $result = PSnake\Get-SnakeModuleRootPath -ModuleManifestPath (Join-Path -Path $TestDrive -ChildPath 'MyModule')
