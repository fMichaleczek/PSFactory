...
Describe 'New-SnakeJaCoCoDocument' {
    BeforeAll {
        ...
        Context 'When there is just one class' {
            Context 'When there is one hit and one miss' {
                ...
                It 'Should have added the report counter <CounterName> with the correct attributes' -ForEach @(
                    ...
                    $xmlResult = PSnake\New-SnakeJaCoCoDocument -MissedCommands $mockMissedCommands -HitCommands $mockHitCommands -PackageName $mockPackageName
