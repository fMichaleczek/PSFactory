...
Describe 'Invoke-SnakeGit' {
    ...
    Context 'When successfully calling git' {
        ...
        It 'Should call git with one expected argument' {
            { PSnake\Invoke-SnakeGit -Argument @('log') } | Should -Not -Throw
        ...
        It 'Should call git with two expected arguments' {
            { PSnake\Invoke-SnakeGit -Argument @('describe', '--contains') } | Should -Not -Throw
    ...
    Context 'When git returns an error' {
        ...
        It 'Should throw the correct error' {
            { PSnake\Invoke-SnakeGit -Argument @('log') } | Should -Throw -ExpectedMessage 'git returned exit code 1 indicated failure.'
    ...
    Context 'When git does not exist' {
        It 'Should throw an error' {
            { PSnake\Invoke-SnakeGit -Argument @('log') } | Should -Throw -ExpectedMessage 'git: StubNotImplemented'
        }
    }
}
