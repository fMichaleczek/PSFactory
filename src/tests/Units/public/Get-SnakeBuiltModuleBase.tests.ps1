...
Describe 'Get-SnakeBuiltModuleBase' {
    Context 'When passing mandatory parameters' {
        It 'Should return the correct path' {
            $result = PSnake\Get-SnakeBuiltModuleBase -OutputDirectory $TestDrive -ModuleName 'MyModule'
    ...
    Context 'When passing parameter BuildModuleSubdirectory' {
        It 'Should return the correct path' {
            $result = PSnake\Get-SnakeBuiltModuleBase -OutputDirectory $TestDrive -ModuleName 'MyModule' -BuiltModuleSubdirectory 'builtModule'
    ...
    Context 'When passing parameter VersionedOutputDirectory' {
        It 'Should return the correct path' {
            $result = PSnake\Get-SnakeBuiltModuleBase -OutputDirectory $TestDrive -ModuleName 'MyModule' -VersionedOutputDirectory
    ...
    Context 'When passing parameter ModuleVersion' {
        Context 'When passing an asterisk as module version' {
            ...
            #>
            It 'Should return the correct path' {
                $result = PSnake\Get-SnakeBuiltModuleBase -OutputDirectory $TestDrive -ModuleName 'MyModule' -ModuleVersion '*'
        ...
        Context 'When passing an specific module version' {
            It 'Should return the correct path' {
                $result = PSnake\Get-SnakeBuiltModuleBase -OutputDirectory $TestDrive -ModuleName 'MyModule' -ModuleVersion '2.0.0'
