...
Describe 'New-SnakeXmlJaCoCoCounter' {
    ...
    Context 'When calling without PassThru' {
        It 'Should append the correct element' {
            InModuleScope -ScriptBlock {
                ...
                { New-SnakeXmlJaCoCoCounter -XmlNode $mockElement -CounterType 'LINE' -Covered 2 -Missed 1 } | Should -Not -Throw
    ...
    Context 'When calling with PassThru' {
        It 'Should append the correct element' {
            InModuleScope -ScriptBlock {
                ...
                $result = New-SnakeXmlJaCoCoCounter -XmlNode $mockElement -CounterType 'LINE' -Covered 2 -Missed 1 -PassThru
