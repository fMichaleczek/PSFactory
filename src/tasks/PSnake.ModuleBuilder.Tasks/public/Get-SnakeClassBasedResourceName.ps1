...
<#
    ...
    .DESCRIPTION
        ...
        For MOF-based DSC Resources, look at the `Get-SnakeMofSchemaName` function.
    ...
    .EXAMPLE
        ...
        Get-SnakeClassBasedResourceName -Path (Join-Path -Path (Get-Module MyResourceModule).ModuleBase -ChildPath (Get-Module MyResourceModule).RootModule)

#>
function Get-SnakeClassBasedResourceName
{
   [CmdletBinding()]
   [OutputType([String[]])]
   param
