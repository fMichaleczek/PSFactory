BeforeAll {
    ...
    {
        $env:PSFactoryRequiredModulesPath = $requiredModulesPath
        $env:PSFactoryBuildModuleOutput = $buildModuleOutput
    ...
    {
        $inModuleScopeParameters = @{
            requiredModulesPath = $env:PSFactoryRequiredModulesPath
            buildModuleOutput   = $env:PSFactoryBuildModuleOutput
        }
    }
...
Describe 'Set-FactoryPSModulePath' {
    ...
    Context 'Testing return values' {
        ...
        It 'Should return exactly one object when PassThru is specified' {
            InModuleScope -ScriptBlock {
                $result = Set-FactoryPSModulePath -PSModulePath $PSModulePath -BuiltModuleSubdirectory $buildModuleOutput -RequiredModulesDirectory $requiredModulesPath -PassThru
        ...
        It 'Should return nothing when PassThru is not specified' {
            InModuleScope -ScriptBlock {
                $result = Set-FactoryPSModulePath -PSModulePath $PSModulePath -BuiltModuleSubdirectory $buildModuleOutput -RequiredModulesDirectory $requiredModulesPath
    ...
    Context 'Testing ShouldProcess' {
        ...
        It 'Should not alter the PSModulePath when WhatIf is specified' {
            InModuleScope -ScriptBlock {
                ...
                Set-FactoryPSModulePath -PSModulePath $PSModulePath -BuiltModuleSubdirectory $buildModuleOutput -RequiredModulesDirectory $requiredModulesPath -WhatIf
