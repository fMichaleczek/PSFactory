...
Describe 'Get-FactoryModuleRootPath' {
    Context 'When module manifest does not contain the property RootModule' {
        ...
        It 'Should return $null' {
            $result = PSFactory\Get-FactoryModuleRootPath -ModuleManifestPath $TestDrive
    ...
    Context 'When module manifest property RootModule' {
        ...
        It 'Should return $null' {
            $result = PSFactory\Get-FactoryModuleRootPath -ModuleManifestPath (Join-Path -Path $TestDrive -ChildPath 'MyModule')
