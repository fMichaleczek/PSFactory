...
Describe 'Set-FactoryTaskVariable' {
    ...
    Context 'When calling the function with parameter AsNewBuild' {
        ...
        It 'Should return the expected output' {
            <#
                Since PSFactory adds its own alias in build.ps1 that does not point
                to the built module's Set-FactoryTaskVariable we must point
                out that the alias to test is the one in the module.
            #>
            $result = . PSFactory\Set-FactoryTaskVariable -AsNewBuild
        ...
        Context 'When BuiltSubModuleDirectory is set in the build configuration file' {
            ...
            It 'Should return the expected output' {
                $result = . PSFactory\Set-FactoryTaskVariable -AsNewBuild -Verbose
    ...
    Context 'When calling the function without a parameter' {
        ...
        It 'Should return the expected output' {
            <#
                ...
                out that the alias to test is the one in the module.
            #>
            $result = . PSFactory\Set-FactoryTaskVariable
        ...
        Context 'When BuiltSubModuleDirectory is set in the build configuration file' {
            ...
            It 'Should return the expected output' {
                <#
                    ...
                    out that the alias to test is the one in the module.
                #>
                $result = . PSFactory\Set-FactoryTaskVariable -Verbose
