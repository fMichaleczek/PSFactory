...
if (Test-Path $PSScriptRoot/scripts/Set-FactoryTaskVariable.ps1)
{
    Set-Alias -Name Set-FactoryTaskVariable -Value $PSScriptRoot/scripts/Set-FactoryTaskVariable.ps1
    # Set-Alias -Name 'PSFactory.Tasks' -Value "$PSScriptRoot/build.tasks.ps1" -Force -ErrorAction Ignore
}
