...
Describe 'Set-FactoryTaskVariable' {
    It 'Should have exported the alias correct' {
        ...
        #>
        $taskAlias = Get-Alias -Name 'Set-FactoryTaskVariable' -Scope 'Global'

        $taskAlias.Name | Should -Be 'Set-FactoryTaskVariable'
        $taskAlias.ReferencedCommand | Should -Be 'Set-FactoryTaskVariable.ps1'
        $taskAlias.Definition | Should -Match 'PSFactory[\/|\\]\d+\.\d+\.\d+[\/|\\]scripts[\/|\\]Set-FactoryTaskVariable\.ps1'
    }
    ...
    Context 'When called with parameter AsNewBuild' {
        ...
        It 'Should run the scripts and return correct values for variables' {
            . PSFactory\Set-FactoryTaskVariable -AsNewBuild
    ...
    Context 'When called without any parameter' {
        ...
        It 'Should run the scripts and return correct values for variables' {
            . PSFactory\Set-FactoryTaskVariable
