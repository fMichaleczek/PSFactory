...
<#
    ...
    .DESCRIPTION
        Add-SnakeBlueprint is an helper function to invoke a plaster template built-in the PSnake module.
    ...
    .EXAMPLE
        C:\src\MyModule> Add-SnakeBlueprint -Kind PublicFunction -PublicFunctionName Get-MyStuff

    .NOTES
        This module requires and uses Plaster.
#>
function Add-SnakeBlueprint
{
