...
<#
    ...
    .DESCRIPTION
        New-SnakeProject helps you bootstrap your PowerShell module project by
    ...
    .EXAMPLE
        C:\src> New-SnakeProject -DestinationPath . -ModuleType CompleteSample -ModuleAuthor "Gael Colas" -ModuleName MyModule -ModuleVersion 0.0.1 -ModuleDescription "a sample module" -LicenseType MIT -SourceDirectory Source

    .NOTES
        See Add-SnakeBlueprint to add elements such as functions (private or public), tests, DSC Resources to your project.
#>
function New-SnakeProject
{
    ...
    $templateSubPath = 'Templates/PSnake'
    $snakeBase = $MyInvocation.MyCommand.Module.ModuleBase

    $invokePlasterParam = @{
        TemplatePath = Join-Path -Path $snakeBase -ChildPath $templateSubPath
