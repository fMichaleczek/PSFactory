...
<#
    ...
    .DESCRIPTION
        This command finds the Module Manifest of the current PSFactory project,
    ...
    .EXAMPLE
        Get-FactoryProjectModuleManifest -BuildRoot .

#>
function Get-FactoryProjectModuleManifest
{
    [CmdletBinding()]
